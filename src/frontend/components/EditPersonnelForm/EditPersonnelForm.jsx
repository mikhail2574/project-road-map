          ...
          <StyledModalInputWrapper>
            ...
            <Controller
              ...
              rules={{
                ...
                pattern: {
                  value:
                    /^[А-ЯІ][а-яі'-]+\s[А-ЯІ]\.[А-ЯІ]\.$|^[А-ЯІ][а-яі'-]+\s[А-ЯІ][а-яі]+\s[А-ЯІ][а-яі]+$|^[А-ЯІ][а-яі'-]+-[А-ЯІ][а-яі'-]+\s[А-ЯІ]\.[А-ЯІ]\.$|^[А-ЯІ][а-яі'-]+-[А-ЯІ][а-яі'-]+\s[А-ЯІ][а-яі]+\s[А-ЯІ][а-яі]+$|^[А-ЯІ][а-яі'-]+\s-\s[А-ЯІ][а-яі'-]+\s[А-ЯІ]\.[А-ЯІ]\.$|^[А-ЯІ][а-яі'-]+\s-\s[А-ЯІ][а-яі'-]+\s[А-ЯІ][а-яі]+\s[А-ЯІ][а-яі]+$/,
                  message:
